...
import br.com.systeconline.rule.FacadeHistoricoLancamento;
import br.com.systeconline.tables.financeiro.HistoricoLancamento;
...
public class BeanHistoricoLancamento extends BeanSuperClass{
	...
	public String salvar() {
		...
		try {
			...
			historico.setCodEmp(getCodEmpLogado());
